Arguments: 
  /usr/local/bin/node /usr/local/Cellar/yarn/1.19.1/libexec/bin/yarn.js add typedoc.json

PATH: 
  /usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/Shared/scripts
...
Trace: 
  Error: https://registry.yarnpkg.com/typedoc.json: Not found
...
Lockfile: 
  ...
  react-native-events@^1.0.9:
    version "1.0.13"
    resolved "https://registry.yarnpkg.com/react-native-events/-/react-native-events-1.0.13.tgz#8d42a7707377d9a03b4de82f1808a7a988b403ff"
    integrity sha512-ogLtW6SFdXQ+L2FRqOMm7DlBKI2XJuey8qlKY6rh0gi7hN69TCLtwnW+zW+Fn0ki/RfOVXKRHflfvV/miKpU+Q==
    dependencies:
      events "^1.1.1"
